...
export default async function BlogPost({ params }: { params: any }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 pt-[10vh] md:py-12 justify-between">

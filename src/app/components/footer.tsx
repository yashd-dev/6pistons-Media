...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-red-500" id="about" ref={ref}>
      <div
        className=" w-full px-4 relative z-50 mx-auto md:px-28 text-white "
        style={{
        ...
        <div className="gap-4 p-4 py-16 sm:pb-16 md:flex md:justify-between">
          <div className="mb-12 flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              <img className="h-7 w-7" src="/logo.svg" alt="6pistons Logo" />
              <span className="self-center whitespace-nowrap text-2xl md:text-4xl font-semibold text-white">
                6pistons
              </span>
            </Link>
